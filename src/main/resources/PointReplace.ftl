...
<h3><form action="/files/replace/${file}" method="post" enctype="multipart/form-data">
...
<h3><button type="button" style="color: red" id="назад" onclick="location.href='/files/delite/${bucketName}/${filename}'">назад</button></h3>
